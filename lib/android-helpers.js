...
helpers.setEmuOrientation = async function (orientation) {
  orientation = orientation.toUpperCase();
  let currentOrientation = await this.getOrientation();
  if (currentOrientation !== orientation) {
    await this.adb.rotate();
    await this.setEmuOrientation(orientation);
  }
}
